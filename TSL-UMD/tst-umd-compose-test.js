...
const message = compose({
  address: 2,
  brightness: 3,
  label: 'CLIP NAME HEREEEEEEEEEEEEEEE',
  t1: 0,
  t2: 0,
  t3: 0,
  t4: 0
...
const targetAddress = '127.0.0.1'; // Replace with the actual target address
const targetPort = 40001; // Replace with the actual target port // carbonite appaerntly has input on port 5257
